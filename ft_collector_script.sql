/*
You may need to enable xp_cmdshell prior to running this script as it is disabled by default
...
PRINT''
PRINT '******** Full-Text Service & FDHOST configuration values ********'
PRINT '*****************************************************'
PRINT ''
go
sp_fulltext_service 'aggressive_break'
go
sp_fulltext_service 'auto_crawl_end_fragments_merge'
go
sp_fulltext_service 'batch_size'
go
sp_fulltext_service 'clean_up'
go
sp_fulltext_service 'connect_timeout'
go
sp_fulltext_service 'crawl_ranges'
go
sp_fulltext_service 'data_timeout'
go
sp_fulltext_service 'fdhost_dump'
go
sp_fulltext_service 'fdhost_tracing'
go
sp_fulltext_service 'fdhost_tracing_numberoflogs'
go
sp_fulltext_service 'fdhost_tracing_tag'
go
...
go
sp_fulltext_service 'max_singledoc_retries'
go
sp_fulltext_service 'outstanding_isms'
go
sp_fulltext_service 'pause_indexing'
go
sp_fulltext_service 'processor_affinity'
go
...
go
sp_fulltext_service 'upgrade_option'
go
